import{u as o,j as a}from"./components-xjxrmaEV.js";import{M as r}from"./MarkdownRenderer-DftEXPFy.js";import{u as n}from"./useTranslation-DoA7T-KL.js";import{T as s}from"./triangle-alert-BfTNRwyT.js";import"./utils-CG_YdLPO.js";import"./external-link-CfexqYf1.js";import"./createLucideIcon-D8il6R_u.js";function y(){const e=o(),{t:i}=n(e.locale),t=l(e.appName,e.supportEmail,e.copyrightHolder);return a.jsxs("div",{className:"max-w-3xl mx-auto space-y-4",children:[a.jsxs("div",{className:"flex items-start gap-2 p-3 rounded-lg bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200",children:[a.jsx(s,{className:"h-4 w-4 shrink-0 mt-0.5"}),a.jsx("p",{className:"text-xs",children:i("legal.draftNotice")})]}),a.jsx("p",{className:"text-xs text-vanta-muted",children:i("legal.lastUpdated",{date:"2026-06-20"})}),a.jsx(r,{content:t})]})}function l(e,i,t){return`# Terms of Service — ${e}

**Last updated: 2026-06-20**

These Terms of Service ("Terms") govern your use of ${e} ("the Service"), an AI agent application embedded in your Shopify admin. By installing or using the Service, you agree to these Terms.

## 1. What the Agent Is Authorized to Do

When you grant the requested Shopify access scopes, ${e} is authorized to:
...
${e} uses **Shopify App Pricing** for billing. Plans and credit allocations are defined in the Shopify Partner Dashboard and managed by Shopify directly.
...
${e}, including its source code, UI design, brand assets, and documentation, is the exclusive property of **${t}**. You receive a limited, revocable, non-transferable license to use the Service for the duration of your subscription.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, ${t} SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, BUSINESS OPPORTUNITY, OR GOODWILL, ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE.

Total liability for any claim shall not exceed the amount you paid to ${e} in the 12 months preceding the claim.

## 12. Indemnification

You agree to indemnify and hold harmless ${t} from any claim arising from:
...
You can terminate these Terms at any time by uninstalling ${e} from your Shopify admin. Upon termination:
...
These Terms are governed by the laws of the jurisdiction where ${t} operates, without regard to conflict-of-laws principles. Disputes will be resolved in the courts of that jurisdiction.
...
`}export{y as default};
//# sourceMappingURL=app.terms-B1lzGAxz.js.map
